...
**Download manuale (Ultima versione):**

È possibile scaricare il file wheel direttamente dall'[ultima versione](https://git.quad4.io/RNS-Things/rns-page-node/releases/latest) e installarlo:
